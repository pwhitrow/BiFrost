...
/*Table structure for table `_bf_comments` */
...
/*Data for the table `_bf_comments` */
...
/*Table structure for table `_bf_discussions` */
...
/*Data for the table `_bf_discussions` */
...
/*Table structure for table `_bf_media` */
...
/*Table structure for table `_bf_organisations` */
...
CREATE TABLE `_bf_organisations` (
  ...
  `watches` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Has watches?',
...
/*Data for the table `_bf_organisations` */

insert  into `_bf_organisations`(`id`,`api_key`,`name`,`url`,`description`,`address`,`tel`,`email`,`replyto`,`admin_email`,`contact`,`reviews`,`discussions`,`watches`,`date_registered`) values (1,'3a50fc16-d89d-11e0-a26b-4040b2058987','pwhitrow.com','http://www.pwhitrow.com','Personal blag and playground','24 Yeoward Rd\r\nClevedon\r\nNorth Somerset\r\nBS215AU','01275 542158','paul@pwhitrow.com','noreplay@pwhitrow.com','paul@pwhitrow.com','Paul Whitrow',1,1,0,'2012-01-24 22:36:54');

/*Table structure for table `_bf_ratings` */
...
/*Data for the table `_bf_ratings` */

insert  into `_bf_ratings`(`id`,`parent_id`,`rating`,`user_id`,`linked_id`) values (1,'0123456789',2,'1','1'),(2,'0123456789',1,'1','2'),(3,'0123456789',1,'1','3'),(4,'0123456789',3,'1','4'),(5,'0123456789',3,'1','5'),(6,'0123456789',3,'1','6'),(7,'0123456789',1,'1','7'),(8,'0123456789',3,'1','8'),(9,'0123456789',3,'1','9'),(10,'0123456789',2,'1','10'),(11,'0123456789',3,'1','11'),(12,'0123456789',5,'1','12'),(13,'0123456789',3,'1','13');

/*Table structure for table `_bf_reviews` */
...
/*Data for the table `_bf_reviews` */
...
/*Table structure for table `_bf_tags` */
...
/*Table structure for table `_bf_users` */
...
/*Data for the table `_bf_users` */

insert  into `_bf_users`(`user_id`,`email`,`password`,`gname`,`fname`,`avatar`,`verified`,`level`,`joined`,`lastlogin`,`enabled`) values (1,'paul@pwhitrow.com','098f6bcd4621d373cade4e832627b4f6','Paul','Whitrow','http://www.gravatar.com/avatar/73b0908c63b1f5f169e82ccfbc381df5?d=404&s=100',1,0,'2011-11-21 15:10:54','2012-01-28 20:33:19',1);

/*Table structure for table `_bf_watches` */

DROP TABLE IF EXISTS `_bf_watches`;

CREATE TABLE `_bf_watches` (
...
/*Data for the table `_bf_watches` */

insert  into `_bf_watches`(`id`,`userid`,`relation`,`api_key`,`type`,`title`,`url`) values (7,1,'0123456789','3a50fc16-d89d-11e0-a26b-4040b2058987','reviews','BiFrost Test Page','');
