...
var fb_lib = {
    ...
    init: function()
    {
        ...
        if(!$('.fb-root').length)
        {
            ...
            .html("<fb:login-button size='small' autologoutlink='true' perms='email,status_update,publish_stream' scope='email,status_update,publish_stream'></fb:login-button>" + _bf.t('Log In'))
            .hide()
            .appendTo($('._bf_state'))
            .click(function()
            {
